...
// 
// How to access to public non-static members defined in another class?
// - in order to access to non-static public members defined in another
//   class, we need to access them via an object of another class 
//
// File name: Example_13.java
...
class SM
{
	...
	public   double getAverage (double m1, double m2)
	{
	...
	// of m1 and m2
	public  int getFinalMark (double m1, double m2)
	{
...
class Example_13
{
	public static void main (String [ ] args)
	{
		...
		// Construct an object of SM class
		SM xyz = new SM ();
		...
		for (int k = 1; k <= 3; ++k)
		{
			...
			gender = xyz.getGender ();
			age = xyz.getAge ();
			
			// To make sure that subject2 is different from subject1
			subject1 = xyz.getASubject ();
			
			do
			{
				subject2 = xyz.getASubject ();
			...
			double average = xyz.getAverage (mark1, mark2);		// mark1 and mark2 known actual parameters
			int finalMark = xyz.getFinalMark (mark1, mark2);
			String grade = xyz.getAGrade (finalMark);
