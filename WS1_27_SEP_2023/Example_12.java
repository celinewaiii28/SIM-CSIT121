...
// 
// How to access to public static members defined in another class?
// - In order to access these methods in another class, we need to access
//   them via the class name.
//
// File name: Example_12.java
...
class SM
{
	...
	public static  double getAverage (double m1, double m2)
	{
	...
	// of m1 and m2
	public static   int getFinalMark (double m1, double m2)
	{
	...
	public static String getAGrade (int mark)
	{
		if (mark >= 85)
			return "HD";
		else if (mark >= 75)
	...
	public static  void displayMessage (String grade)
	{
...
class Example_12
{
	public static void main (String [ ] args)
	{
		...
		for (int k = 1; k <= 3; ++k)
		{
			...
			subject1 = SM.getASubject ();
			
			do
			{
				subject2 = SM.getASubject ();
			...
			double average = SM.getAverage (mark1, mark2);		// mark1 and mark2 known actual parameters
			int finalMark = SM.getFinalMark (mark1, mark2);
			String grade = SM.getAGrade (finalMark);
