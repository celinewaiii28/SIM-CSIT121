...
//                 ==> n is divisible by 9
// File name: Divide9lll.java
// What happens when ArrayList is instance variable
...
class DeepCopy
{
	private ArrayList<IntegerInfo> iiArray;
	
	public DeepCopy (ArrayList<IntegerInfo> iiArray) {
		//VERY IMPORTANT STATEMENT
		this.iiArray = new ArrayList<IntegerInfo> (); // DONT DO THIS OUTSIDE
		
		//Now we do deep copying
...
class Divide9lll
{
	...
	private static void constructArray(ArrayList<IntegerInfo> iiArray) {
		for (int k = 0; k < 6; k++) {
			int n = getAnInteger ();
	...
	private static void displayArray(ArrayList<IntegerInfo> iiArray) {
		for (IntegerInfo ii : iiArray) {
			ii.displayInfo ();
		}
	}
	...
	public static void main (String [ ] args)
	{
		...
		// Declare an ArrayList of integer info object
		ArrayList<IntegerInfo> iiArray = new ArrayList<IntegerInfo> ();
		
		// Construct an array
		constructArray (iiArray);
		
		// Construct and display DeepCopy class object
