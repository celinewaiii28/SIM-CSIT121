...
//                 ==> n is divisible by 9
// File name: Divide9i.java
// Explore a class consist of non static information with some other constructor
...
class Divide9i
{
	...
	public static void main (String [ ] args)
	{
		...
		for (int i = 1; i <= 6; i++)
		{
			...
			int sum = ii.getSumOfDigit ();
			
			//Test divisible by 9
			boolean ok = ii.testDivisible ();
