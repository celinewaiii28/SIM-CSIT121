...
//
// We rename the getString method to toString 
//
// File name: Triangle_1e.java
...
class Triangle
{
 ...
 class TestTriangle_1e
{
	private static void displayInfo (String title, Triangle t)
	{
		// toString method is call explicitely!!!
		System.out.printf ("%s = %s%n", title, t.toString ());
	}
